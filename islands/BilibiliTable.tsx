...
const arrs = [
  "BV1iZLJzuE6S", "BV1BELHzyEMi", "BV1Et4y1r7Eu", "BV1rSNvzeEPt",
  "BV1RkT2zREai", "BV1JtNXzkEFN", "BV1Dc2VYkEce", "BV1VpTpzHEcT",
  "BV1PpZ2YoEtU", "BV1WiNkz4EZM", "BV1a5E1zLE2u", "BV1WmCpYHE5C",
  "BV1M6NBeZEVu", "BV1XXNiznE4X", "BV1pSLgz9EnQ", "BV13j421o7mz",
  "BV1ZS4y1R7q9", "BV1Ur4y1r72B", "BV15y421B7FC", "BV1ytKHzNEDo",
  "BV1esKuzUEkG", "BV1qEVazqEv3", "BV1ogJhz1EbJ", "BV1i3MLzzEjY",
  "BV1PsT2zME58", "BV1dTRrYDEqJ", "BV11cdcY4EbG", "BV11TJ8zZEUR",
  "BV1yQfWYaEVo", "BV1ivM8zJEUg", "BV1y8KWzrEsx", "BV1YGMmzFEXv",
  "BV1uEyuYZEYW", "BV1ud4y1Q7Dd", "BV1R5N9zgE1t", "BV1QdfnYwEFc",
  "BV17tNXzkEDy", "BV1DFfWYTEz3", "BV1FqfnYLE1v", "BV1K2jnz8E8Q",
  "BV1cvfpYsEiJ", "BV12BNdzaEo1", "BV1Fv4y1g7Cc", "BV1AGfWYFEaY",
  "BV1qTTTzjE5T", "BV1qaTdzWELF", "BV1UeK8zAEgM", "BV1DaMyzmEgc",
  "BV1ACTezqEZ9", "BV1HsTyz8EBL", "BV1HBMmz3Ehp", "BV1dQKGzoEVA",
  "BV1aFK4zfEjT", "BV1o2KgzpEuv", "BV1mGK7zfEqT", "BV1egTzzeEu4",
  "BV1BBKJzSEaM", "BV1CUMHzBE3L", "BV11KK3zzEL1", "BV1c6KGzKEk2",
  "BV1YgM3z9EJ3", "BV1zEKuzXENd", "BV1eTKYzEE2g", "BV1JhMEzWEFQ",
  "BV1bqMczxEoG", "BV1jsMAzGE2a", "BV1AYNLzyErV", "BV16PMSzGETR",
  "BV1hrKVzWEsP", "BV1SAMtzYE3M", "BV18V4y1j7ja", "BV13W4y1U7NP",
  "BV1vFKbzqED1", "BV1mM4m167tL", "BV1MgEjzxEfv",
];
...
function arrsToKey(arr: string[]) {
  return JSON.stringify(arr);
}

function getCache(): BilibiliData[] | null {
  try {
...
function setCache(data: BilibiliData[]) {
  localStorage.setItem(CACHE_KEY, JSON.stringify(data));
  localStorage.setItem(CACHE_TIME_KEY, Date.now().toString());
  localStorage.setItem(CACHE_ARRS_KEY, arrsToKey(arrs));
}

export default function BilibiliTable() {
  const [bilibilis, setBilibilis] = useState<BilibiliData[]>([]);
  ...
  const loadData = async () => {
    ...
    const newBilibilis: BilibiliData[] = [];
    for (let i = 0; i < arrs.length; i++) {
      ...
      try {
        ...
        console.error(`Error loading data for ${bvid}:`, e);
